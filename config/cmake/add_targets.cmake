...
function(build_common target include_directories definitions compile_options link_targets link_options)
  ...
  target_compile_options(
    "${target}"
    PRIVATE
    $<$<BOOL:LIB_AT_HEAD_CXX_ENABLE_SANITIZERS>:-fsanitize=address,undefined>
  ...
  target_link_options(
    ...
    $<$<BOOL:LIB_AT_HEAD_CXX_ENABLE_SANITIZERS>:-fsanitize=address,undefined>
    $<$<CONFIG:Debug>:-fstack-protector-strong>
    $<$<CONFIG:Release>:-flto=thin -fsanitize=cfi>
    "${link_options}"
  )
endfunction()
...
#     `-fsanitize=address,undefined -fstack-protector-strong` for debug builds, `-fsanitize=cfi
#     -flto=thin` for release builds, and `-fuse-lld` for all builds.
...
function(cxx_test)
  cxx_library(${ARGN} LIBRARY_TYPE OBJECT)
  extract_target_args("" ${ARGN})
  ...
  target_include_directories(
    ...
    PRIVATE
      ...
      "${PROJECT_SOURCE_DIR}/third_party/preprocessor/include"
      "${PROJECT_SOURCE_DIR}/third_party/vmd/include"
  )
endfunction()
